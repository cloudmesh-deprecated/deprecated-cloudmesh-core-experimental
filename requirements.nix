...
rec {
  ...
  boto3 = buildPythonPackage {
      ...
      format = "wheel";
      buildInputs = [  ];
      propagatedBuildInputs = [ s3transfer ];
      doCheck = false;
    }
    ;
  botocore = buildPythonPackage {
      name = "botocore-1.5.37";
      src = fetchurl {
        url = "https://pypi.python.org/packages/a9/d0/6952038bbc2d7ef169e836c99bc6c95a7dc2b51613694d99d7103f80fa88/botocore-1.5.37-py2.py3-none-any.whl";
        sha256 = "2dcd4a39ef3549919008efc62fb3fca74e0a4c2af31f39813fbd63f77ec11092";
      };
      format = "wheel";
      buildInputs = [  ];
  ...
  s3transfer = buildPythonPackage {
      ...
      src = fetchurl {
        url = "https://pypi.python.org/packages/c0/b5/f759ba12ebcbe2f9e2f70b0803a1619e51fc343e9aeabc7c883dabd95405/s3transfer-0.1.10-py2.py3-none-any.whl";
        sha256 = "bc52f38637f37572ae180c08a2dd87a4825b46713797633aab6e1a42d6b2b8ff";
      };
      format = "wheel";
      buildInputs = [  ];
